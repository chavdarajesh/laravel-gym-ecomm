...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Flavors /</span> All Flavors /</span> Edit Flavor</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <hr class="my-0" />
                <div class="card-body">
                    <form id="form" method="POST" action="{{ route('admin.flavors.update') }}"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" type="text"
                                    id="name" name="name" value="{{ $Flavor['name'] }}" autofocus />
