            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="form" method="POST" action="{{ route('admin.products.update') }}"
                        ...
                        <input type="hidden" name="old_image" value="{{ $Product['image'] }}" id="old_image">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select multiple class="form-select select2 @error('subcategories') is-invalid @enderror" id="subcategories"
                                    ...
                                    <option {{ in_array($subcategorie->id, $Product->subcategories->pluck('id')->toArray()) ? 'selected' : '' }} value="{{ $subcategorie->id }}">{{ $subcategorie->name }}</option>
                                    @endforeach
                                </select>
