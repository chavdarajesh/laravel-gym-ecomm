                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        ...
                        <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('user.profile.setting.index') }}">
                                    <i class="bx bx-user me-2"></i>
                                    <span class="align-middle">Profile Setting</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('user.profile.settings.password.index') }}">
                    ...
                    <li>
                        <a target="_blank" class="dropdown-item" href="{{ route('front.home') }}">
