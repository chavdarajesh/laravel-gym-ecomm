...
<head>
    ...
    <title>{{env('APP_NAME', 'Laravel App')}} | Account Password</title>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            ...
                                            {{env('APP_NAME', 'Laravel App')}} Account Password</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Thank you for choosing Us. Your Account And Your First Payment Is Now
                                            Verifed And Your Password For Your Account Is Here.
                                        </p>
