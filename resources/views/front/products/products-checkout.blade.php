            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <ul class="nav nav-tabs nav-fill border-bottom mb-5 flex-column flex-md-row">
                        <li class="nav-item"><a class="nav-link text-dark" href="{{ route('front.products-cart') }}">Shopping cart</a></li>
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="javascript:void(0);">Billing Information</a></li>
                    ...
                    <form action="{{ route('front.orders.checkout.post') }}" method="post" id="checkout-form">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 mb-3">
                                        ...
                                        <input id="phone"
                                            ...
                                            type="tel" name="phone" placeholder="Enter your phone address"
                                    ...
                                    <!-- Address 1 -->
                                    <div class="form-group col-12 mb-3">
                                        <label for="address_line_1" class="form-label small text-uppercase">Address
                                            1</label>
                                        <input id="address_line_1"
                                            class="form-control @error('address_line_1') border border-danger @enderror"
                                            type="text" name="address_line_1" placeholder="Enter your address line 1"
                                            value="{{ old('address_line_1', $user->address) }}">
                                    ...
                                    <!-- Address 2 -->
                                    <div class="form-group col-12 mb-3">
                                        <label for="address_line_2" class="form-label small text-uppercase">Address
                                            2</label>
                                    ...
                                    <div class="form-group col-lg-6 mb-3">
                                        ...
                                        <input id="state"
                                            ...
                                            type="text" name="state" placeholder="Enter your state"
                                            value="{{ old('state') }}">
                                    ...
                                    <div class="form-group col-lg-6 mb-3">
                                        ...
                                        <input id="postal_code"
                                            ...
                                            type="text" name="postal_code" placeholder="Enter your postal code"
                            ...
                            <div class="col-lg-6 mx-auto">
                                ...
                                <div class="bg-light p-3 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="font-weight-bold mb-0">
                                            {{ $shippingCharge !== null && $shippingCharge == 0 ? 'Free' : '$' . $shippingCharge }}
                                        </p>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="bg-light p-3">
                                    ...
                                    <input class="form-check-input" type="hidden" name="payment_type" id="online"
                                        value="online">
