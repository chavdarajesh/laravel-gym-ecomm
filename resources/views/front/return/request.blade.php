...
<div class="form-group mb-3">
    ...
    <div id="reference_id_error" class="text-danger">
        @error('reference_id') {{ $message }} @enderror
    </div>
</div>
...
<div class="form-group mb-3">
    ...
    <div id="product_ids_error" class="text-danger">
        @error('product_ids') {{ $message }} @enderror
    </div>
</div>
...
<div class="form-group mb-3">
    ...
    <div id="photo_proof_error" class="text-danger">
        @error('photo_proof') {{ $message }} @enderror
    </div>
</div>
...
<div class="form-group mb-3">
    ...
    <div id="return_date_time_error" class="text-danger">
        @error('return_date_time') {{ $message }} @enderror
    </div>
</div>
...
<div class="form-group mb-3">
    ...
    <input type="text" name="bank_name"
        class="form-control @error('bank_name') border border-danger @enderror"
        value="{{ old('bank_name') }}">
    <div id="bank_name_error" class="text-danger">
...
{{-- Branch Name --}}
<div class="form-group mb-3">
    <label class="form-label small text-uppercase">Branch Name</label>
    <input type="text" name="branch_name"
        class="form-control @error('branch_name') border border-danger @enderror"
        value="{{ old('branch_name') }}">
    <div id="branch_name_error" class="text-danger">
...
<div class="form-group mb-3">
    ...
    <select name="account_type"
        class="form-control @error('account_type') border border-danger @enderror">
        <option value="">-- Select Account Type --</option>
        <option value="savings" {{ old('account_type') == 'savings' ? 'selected' : '' }}>Saving</option>
        <option value="current" {{ old('account_type') == 'current' ? 'selected' : '' }}>Current</option>
    </select>
    <div id="account_type_error" class="text-danger">
...
{{-- IFSC Code --}}
<div class="form-group mb-3">
    <label class="form-label small text-uppercase">IFSC Code</label>
    <input type="text" name="ifsc_code"
        class="form-control @error('ifsc_code') border border-danger @enderror"
        value="{{ old('ifsc_code') }}">
    <div id="ifsc_code_error" class="text-danger">
        @error('ifsc_code') {{ $message }} @enderror
    </div>
</div>

{{-- Bank Account Number --}}
<div class="form-group mb-3">
    <label class="form-label small text-uppercase">Bank Account No</label>
    <input type="text" name="bank_account_no"
        class="form-control @error('bank_account_no') border border-danger @enderror"
        value="{{ old('bank_account_no') }}">
    <div id="bank_account_no_error" class="text-danger">
        @error('bank_account_no') {{ $message }} @enderror
    </div>
</div>

{{-- Confirm Bank Account Number --}}
<div class="form-group mb-3">
    <label class="form-label small text-uppercase">Confirm Bank Account No</label>
    <input type="text" name="bank_account_no_confirmation"
        class="form-control @error('bank_account_no_confirmation') border border-danger @enderror"
        value="{{ old('bank_account_no_confirmation') }}">
    <div id="bank_account_no_confirmation_error" class="text-danger">
        @error('bank_account_no_confirmation') {{ $message }} @enderror
    </div>
</div>

{{-- Bank Account Holder Name --}}
<div class="form-group mb-3">
    <label class="form-label small text-uppercase">Bank Account Holder Name</label>
    <input type="text" name="bank_account_holder_name"
        class="form-control @error('bank_account_holder_name') border border-danger @enderror"
        value="{{ old('bank_account_holder_name') }}">
    <div id="bank_account_holder_name_error" class="text-danger">
        @error('bank_account_holder_name') {{ $message }} @enderror
    </div>
</div>
...
<div class="form-group mb-3">
    ...
    <textarea name="return_reason"
        class="form-control @error('return_reason') border border-danger @enderror"
        rows="3">{{ old('return_reason') }}</textarea>
    <div id="return_reason_error" class="text-danger">
        @error('return_reason') {{ $message }} @enderror
    </div>
</div>
