    ...
    <form action="{{ route('front.orders.return-request.post', $order->id) }}" method="post" enctype="multipart/form-data"
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                    ...
                    <select name="product_ids[]" id="product_ids" multiple
                        ...
                        @foreach ($order->products as $product)
                            <option value="{{ $product->id }}"
                                ...
                                {{ $product->name }} ( {{ $product->pivot->price }} x {{ $product->pivot->quantity }} = ${{ number_format($product->pivot->price * $product->pivot->quantity, 2) }})
                            </option>
                        @endforeach
                    </select>
                    <div class="text-danger">
                ...
                {{-- Branch Code --}}
                <div class="form-group mb-3">
                    <label class="form-label small text-uppercase">Branch Code</label>
                    <input type="text" name="branch_code"
                        class="form-control @error('branch_code') border border-danger @enderror"
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="text-danger">
                        @error('bank_account_no_confirmation')
                            {{ $message }}
                        @enderror
                    </div>
                </div>
