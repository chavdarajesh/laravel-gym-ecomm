...
class OrderStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $statuses = [
            ...
            ['name' => 'Cancelled By Admin', 'description' => 'Order has been cancelled by the admin.', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Payment Pending', 'description' => 'Payment is pending.', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Payment Failed', 'description' => 'Payment has failed.', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Payment Completed', 'description' => 'Payment has been completed.', 'created_at' => now(), 'updated_at' => now()],
        ];
